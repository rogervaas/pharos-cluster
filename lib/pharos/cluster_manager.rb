...
module Pharos
  class ClusterManager
    ...
    def apply_reboot_hosts(hosts, parallel: true)
      apply_phase(Phases::Drain, hosts, parallel: parallel) if config.master_hosts.any?(&:master_valid?)
      apply_phase(Phases::RebootHost, hosts, parallel: parallel)
    end
